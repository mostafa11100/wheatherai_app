...
class WeatheResponse {
  ...
  WeatheResponse({this.location, this.current, this.forecast});

  WeatheResponse.fromJson(Map<String, dynamic> json) {
    location =
